                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(0, 20.0, 0.0, 0.0),
                          child: Container(
                            width: 332.0,
                            height: 55.0,
  ...
  enterPin({
    ...
    if (pin != null) {
      ...
      if (response['status']) {
        ...
        final withdrawResponse = await Accounts.withdraw(
          bankName: bankName,
