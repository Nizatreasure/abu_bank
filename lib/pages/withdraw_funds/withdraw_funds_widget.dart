                    ...
                    if (confirm) {
                      enterPin(
                        ...
                        amount: RemoveThousandSeparator(_model
                            ...
                            .toString(),
                        bankName: selectedBank!.name,
                        beneficiaryAccount: _model.textController1.text.trim(),
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: AbuBankTheme.of(context).bodyMedium.override(
                          fontFamily: 'Roboto',
                          color: isBalanceSufficient(_amountController, context)
                              ? AbuBankTheme.of(context).primaryText
                              : AbuBankTheme.of(context).error,
                        ),
                    keyboardType: TextInputType.number,
                    ...
                    bool confirm = await Navigator.push(
                          ...
                          PageTransition(
                            ...
                            child: ComfirmTranferWidget(
                              ...
                              amount: RemoveThousandSeparator(_amountController
                                      .text
                                      .trim()
                                      .substring(1)
                                      .trim())
