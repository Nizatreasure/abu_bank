...
import '/components/mobile_network_section/mobile_network_section_widget.dart';
...
import 'mobileprepaid_model.dart';
export 'mobileprepaid_model.dart';

class MobileprepaidWidget extends StatefulWidget {
  const MobileprepaidWidget({Key? key}) : super(key: key);

  @override
  _MobileprepaidWidgetState createState() => _MobileprepaidWidgetState();
}

class _MobileprepaidWidgetState extends State<MobileprepaidWidget> {
  late MobileprepaidModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MobileprepaidModel());
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      height:
                                          MediaQuery.of(context).size.height *
                                              0.65,
                                      child: MobileNetworkSectionWidget(),
                                    ),
                                  ),
                                );
                              },
